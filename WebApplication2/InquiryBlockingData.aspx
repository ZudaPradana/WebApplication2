<%@ Page Title="Inquiry Blocking Data" MasterPageFile="~/Site.Master" Language="vb" AutoEventWireup="false" CodeBehind="InquiryBlockingData.aspx.vb" Inherits="WebApplication2.InquiryBlockingData" %>
    ...
    <form id="form1">
        ...
        <div class="container mt-4">
            <div class="row mb-3">
                ...
                <div class="col">
                    <label>Case ID</label>
                    <asp:TextBox ID="txtCaseId" runat="server" CssClass="form-control" placeholder="Case ID"></asp:TextBox>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col">
            ...
            <div class="row mb-3">
                <div class="col">
                    <asp:Button ID="btnReset" runat="server" Text="Reset" CssClass="btn btn-light" OnClick="btnReset_Click" causesValidation ="false"/>
            ...
            <div class="row mb-3">
                <div class="col">
                    ...
                    <asp:LinkButton ID="LinkButton1" runat="server" CssClass="btn btn-outline-secondary" OnClick="btnDownloadXLS_Click" causesValidation="false">
                    ...
                    <asp:LinkButton ID="LinkButton2" runat="server" CssClass="btn btn-outline-secondary" OnClick="btnDownloadTXT_Click" causesValidation="false">
            ...
            <div class="table-responsive">
                <asp:GridView ID="GridView1" runat="server" CssClass="table table-striped table-bordered" AutoGenerateColumns="False" AllowPaging="True" PageSize="5" OnPageIndexChanging="GridView1_PageIndexChanging">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="View Blocking Data">
                            <ItemTemplate>
                                <asp:Button CausesValidation="false" ID="btnDetails" runat="server" Text="Details" CssClass="btn btn-primary" CommandName="ViewDetails" CommandArgument='<%# Eval("CaseID") %>' />
                            </ItemTemplate>
